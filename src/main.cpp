...
unsigned int nTargetSpacing = 5 * 60; // 300 seconds
unsigned int nStakeMinAge = 2 * 60 * 60; // 2 hours
unsigned int nStakeMaxAge = 4 * 60 * 60;           // 4 hours
...
const string strMessageMagic = "Xecoin Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT =  105120;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Xecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "September 2, 2016 Bitfinex Reimburses First Bitcoin Exchange Hack Victims";
        CTransaction txNew;
        txNew.nTime = 1472858552;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1472858552;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1868137;
		if(fTestNet)
        {
            block.nNonce   = 1868137;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3e782619fbf3ee8946b5299f6d856e787aae0743c0cc960fbcae26c2a103562c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb4, 0xc9, 0xd8 };
