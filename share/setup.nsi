...
!define MUI_ICON "../share/pixmaps/xecoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\xecoin-qt.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/xecoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/xecoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\xecoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\xecoin-qt.exe
